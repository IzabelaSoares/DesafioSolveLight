<%-- 
    Document   : receberdadosconsulta
    Created on : 27/06/2021, 16:01:50
    Author     : Izabela
--%>
    ...
    <body>
      <header>
        ...
        <%
          ...
          //PEGAR OS PARAMETROS
          String dataa = request.getParameter("dataentrada");
	  String datab = request.getParameter("datafinal");
 
          //CHAMAR O METODO
	  Ponto ponto = new Ponto();
          List<Ponto> pontodata = ponto.consultarData(dataa, datab);		
        %>
            <div>
